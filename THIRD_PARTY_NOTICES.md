...
OriCode's own code is under the MIT license in LICENSE. It builds on the following, each under its own terms.

## Compiled into the app

- [MarkdownUI](https://github.com/gonzalezreal/swift-markdown-ui) 2.4.1, MIT, © 2020 Guillermo Gonzalez
- [NetworkImage](https://github.com/gonzalezreal/NetworkImage) 6.0.1, MIT, © 2020 Guille Gonzalez
...
- [Claude Agent SDK](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk), © Anthropic PBC, all rights reserved. It's installed from npm when the engine is built, isn't part of this repository and isn't covered by its license. Its use is subject to [Anthropic's legal agreements](https://code.claude.com/docs/en/legal-and-compliance).
