...
export type Model = { id: string; name: string; description: string; efforts: string[]; fast: boolean };
...
export const fallback: Model[] = [
  { id: "default", name: "Default", description: "The model Claude Code picks", efforts: ["low", "medium", "high", "xhigh", "max"], fast: false },
  { id: "opus", name: "Opus", description: "Most capable", efforts: ["low", "medium", "high", "xhigh", "max"], fast: false },
  { id: "sonnet", name: "Sonnet", description: "Fast and capable", efforts: ["low", "medium", "high", "xhigh", "max"], fast: false },
  { id: "haiku", name: "Haiku", description: "Fastest", efforts: [], fast: false },
];
